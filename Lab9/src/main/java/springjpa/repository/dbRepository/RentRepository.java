...
import springjpa.domain.validators.SQLRepoException;
...
public interface RentRepository extends CatalogRepository<Rent,Integer>{

    default Iterable<Rent> findAll(Sort sort) {
        ArrayList<Rent> result = new ArrayList<>((Collection<? extends Rent>) findAll());
